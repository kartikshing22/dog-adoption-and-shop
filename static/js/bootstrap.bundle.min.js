...
!(function (t, e) {
                        ...
                        ? (function (t, e, n) {
                              return function i(o) {
                                  for (var r = t.querySelectorAll(e), s = o.target; s && s !== this; s = s.parentNode)
                                      for (var a = r.length; a--; ) if (r[a] === s) return (o.delegateTarget = s), i.oneOff && B.off(t, o.type, n), n.apply(s, [o]);
                                  return null;
                              };
                          })(t, n, i)
                        : (function (t, e) {
    ...
    var Lt = {
            ...
            effect: function (t) {
                ...
                null != r &&
                    ...
                    ((e.elements.arrow = r), (e.modifiersData[i + "#persistent"] = { padding: kt("number" != typeof a ? a : At(a, ot)) }));
            },
    ...
    function Dt(t) {
        ...
        return a
            ? Object.assign(
                  Object.assign({}, w),
                  {},
                  (((y = {})[v] = g ? "0" : ""), (y[m] = p ? "0" : ""), (y.transform = (_.devicePixelRatio || 1) < 2 ? "translate(" + f + "px, " + h + "px)" : "translate3d(" + f + "px, " + h + "px, 0)"), y)
              )
            : Object.assign(Object.assign({}, w), {}, (((e = {})[v] = g ? h + "px" : ""), (e[m] = p ? f + "px" : ""), (e.transform = ""), e));
    }
    var xt = {
            name: "computeStyles",
            enabled: !0,
            ...
            fn: function (t) {
                ...
                null != e.modifiersData.popperOffsets &&
                    (e.styles.popper = Object.assign(Object.assign({}, e.styles.popper), Dt(Object.assign(Object.assign({}, c), {}, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s, roundOffsets: l })))),
                    null != e.modifiersData.arrow &&
                        (e.styles.arrow = Object.assign(Object.assign({}, e.styles.arrow), Dt(Object.assign(Object.assign({}, c), {}, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l })))),
    ...
    function te(t, e, n) {
        ...
        return (
            (a || (!a && !n)) &&
                (("body" !== lt(e) || Rt(r)) && (l = (i = e) !== ct(i) && ft(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : Bt(i)), ft(e) ? (((c = Mt(e)).x += e.clientLeft), (c.y += e.clientTop)) : r && (c.x = Ht(r))),
    ...
    function ie(t) {
        ...
        return function (t, e, n) {
            ...
            var o,
                s,
                a = { placement: "bottom", orderedModifiers: [], options: Object.assign(Object.assign({}, ee), r), modifiersData: {}, elements: { reference: t, popper: e }, attributes: {}, styles: {} },
                l = [],
                c = !1,
                u = {
                    state: a,
                    ...
                    forceUpdate: function () {
                        if (!c) {
                            var t = a.elements,
                                ...
                                n = t.popper;
                            if (ne(e, n)) {
                                (a.rects = { reference: te(e, wt(n), "fixed" === a.options.strategy), popper: pt(n) }),
                                    (a.reset = !1),
        ...
        ve = (function (t) {
            ...
            return (
                        ...
                        for (var e = F('[data-bs-toggle="dropdown"]'), n = 0, i = e.length; n < i; n++) {
                            ...
                            if ((t && "click" === t.type && (r.clickEvent = t), o)) {
                                ...
                                if (
                                    ...
                                    !((t && (("click" === t.type && /input|textarea/i.test(t.target.tagName)) || ("keyup" === t.type && "Tab" === t.key)) && a.contains(t.target)) || B.trigger(e[n], "hide.bs.dropdown", r).defaultPrevented)
                                )
                                    "ontouchstart" in document.documentElement &&
                                        (s = []).concat.apply(s, document.body.children).forEach(function (t) {
                ...
                (o.dataApiKeydownHandler = function (t) {
                    if (
                        !(/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || ("Escape" !== t.key && (("ArrowDown" !== t.key && "ArrowUp" !== t.key) || t.target.closest(".dropdown-menu"))) : !le.test(t.key)) &&
                ...
                (r.setElementContent = function (t, e) {
                    if (null !== t)
                        return "object" == typeof e && d(e)
                            ...
                            : void (this.config.html ? (this.config.sanitize && (e = ke(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
                }),
                (r.getTitle = function () {
            ...
            return (
                ...
                (r._activate = function (t) {
                    ...
                    n.classList.contains("dropdown-item")
                        ? (Y(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"), n.classList.add("active"))
